class Sivel2Sjr::Consactividadcaso < ActiveRecord::Base
  ...
  def presenta(atr)
    ...
    if (m && ((m[1] == 'mujer' && self.persona.sexo == Msip::Persona::convencion_sexo[:sexo_femenino]) ||
        (m[1] == 'hombre' && self.persona.sexo == Msip::Persona::convencion_sexo[:sexo_masculino]) ||
        (m[1] == 'sin' && self.persona.sexo == Msip::Persona::convencion_sexo[:sexo_sininformacion]))) then
