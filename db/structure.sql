...
CREATE MATERIALIZED VIEW public.cres1 AS
 SELECT actividad_id,
  ...
  WHERE ((oficina_id = 3) AND (ayudasjr_id IS NOT NULL) AND (ayudasjr_id <> ''::text))
  WITH NO DATA;
