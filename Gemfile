...
gem 'mr519_gen', # Motor de gestion de formularios y encuestas
  git: 'https://gitlab.com/pasosdeJesus/mr519_gen.git', branch: :msip
  #path: '../mr519_gen'

gem 'heb412_gen',  # Motor de nube y llenado de plantillas
  git: 'https://gitlab.com/pasosdeJesus/heb412_gen.git', branch: :msip
  #path: '../heb412_gen'

# Motor Cor1440_gen
gem 'cor1440_gen',
  git: 'https://gitlab.com/pasosdeJesus/cor1440_gen.git', branch: :msip
  #path: '../cor1440_gen'

# Motor Sal7711_gen
gem 'sal7711_gen',
  git: 'https://gitlab.com/pasosdeJesus/sal7711_gen.git', branch: :msip
  #path: '../sal7711_gen'

# Motor Sal7711_web
gem 'sal7711_web',
  git: 'https://gitlab.com/pasosdeJesus/sal7711_web.git', branch: :msip
  #path: '../sal7711_web'

# Motor de SIVeL 2
gem 'sivel2_gen',
  git: 'https://gitlab.com/pasosdeJesus/sivel2_gen.git', branch: :msip
  #path: '../sivel2_gen'

# Motor de SIVeL 2 - SJR
gem 'sivel2_sjr',
  git: 'https://gitlab.com/pasosdeJesus/sivel2_sjr.git', branch: :msip
  #path: '../sivel2_sjr'
