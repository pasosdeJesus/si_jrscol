#require 'byebug'
require 'test_helper'
require_relative '../../../models/sip/tdocumento_test'
    ...
    class TdocumentosControllerTest < ActionDispatch::IntegrationTest
      ...
      setup do
        ...
        @tdocumento = Sip::Tdocumento.create(
          Sip::TdocumentoTest::PRUEBA_TDOCUMENTO)
      end
      ...
      test "should create tdocumento" do
        assert_difference 'Tdocumento.count', 1 do
          post admin_tdocumentos_path, params: {tdocumento: {
      ...
      test "should update tdocumento" do
        patch admin_tdocumento_path(@tdocumento.id, params: { tdocumento: { 
      ...
      test "should destroy tdocumento" do
        assert_difference('Sip::Tdocumento.count', -1) do
