...
CREATE MATERIALIZED VIEW public.cor1440_gen_benefactividadpf AS
 SELECT be.actividad_fecha,
  ...
  WHERE (true AND (be.actividad_id = ANY (ARRAY[27441, 27214, 26098, 25116, 23542, 4174, 4147, 4145])))
  WITH NO DATA;
