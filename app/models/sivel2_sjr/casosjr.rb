...
module Sivel2Sjr
  ...
  class Casosjr < ActiveRecord::Base
    ...
    has_many :respuesta,
      ...
      validate: true,
      foreign_key: "caso_id" # , dependent: :destroy
    ...
    def oficina_en_territorial_del_usuario
      if defined?(caso.current_usuario) && caso.current_usuario &&
          ...
          oficina_id &&
          oficina.territorial_id != caso.current_usuario.territorial_id
        errors.add(
          :oficina,
    ...
    def beneficiarios_activos
      victimasjr.where(fechadesagregacion: nil)
    end
