...
export default class extends Controller {
  // Conecta con data-controller="enviarautomatico"
  ...
  // repintar agregar `data-enviarautomatico-target='repintar'`
  // En el form agregar `data-enviarautomatico-target='formulario'`
  ...
  enviar(e) {
    ...
    fetch(a, {
      ...
      let selector = `${this.repintarTarget.localName}[data-enviarautomatico-target]` // e.g form[data-enviarautomatico-target]
